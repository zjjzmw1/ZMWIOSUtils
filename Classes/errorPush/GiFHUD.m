...
//@property (nonatomic ,strong) UILabel *myLabel;///自己没事添加的Label.
////@property (nonatomic ,strong) NSString *myLabelString;///动画下面的文字。
...
//        self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, Size - 30, Size - 30)];
//
//        [self addSubview:self.imageView];
//        self.myLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, Size - 30, Size, 30)];
//        self.myLabel.backgroundColor = [UIColor clearColor];
//        self.myLabel.textAlignment = NSTextAlignmentCenter;
//        self.myLabel.font = [UIFont systemFontOfSize:15];
//        self.myLabel.textColor = [UIColor redColor];
//        self.myLabel.text = @"默认的文字...";
...
//        [APPDELEGATE.window bringSubviewToFront:[self instance]];
//        [[self instance] setShown:YES];
//        [[self instance] fadeInWithLabelString:tempString];
//    }];
//}
//
//+ (void)dismiss {
...
//    }];
//}
//- (void)fadeInWithLabelString:(NSString *)tempString{
//    ///给后添加的label赋值。
//    self.myLabel.text = tempString;
//    [self.imageView startAnimating];
//    [UIView animateWithDuration:FadeDuration animations:^{
//        [self setAlpha:1];
//    }];
