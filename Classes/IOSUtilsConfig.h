...
///下面分别是主体红色、背景灰色、字体黑、字体中灰、字体灰。-------------------------------------字体颜色=================================
#define kBaseColor [UIColor colorWithHexString:@"#F15D6D" alpha:1.0f]
#define kBGColor [UIColor colorWithRed:(242)/255.0f green:(242)/255.0f blue:(242)/255.0f alpha:1]
#define kTitleBlackColor [UIColor colorWithHexString:@"#1b1b1b" alpha:1.0f]
#define kTitleMiddleColor [UIColor colorWithHexString:@"#909090" alpha:1.0f]
#define kTitleLightColor [UIColor colorWithHexString:@"#9c9c9c" alpha:1.0f]
#define kTitleLightLightColor [UIColor colorWithHexString:@"#E4E4E4" alpha:1.0f]
